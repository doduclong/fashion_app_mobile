...
class CustomTheme {
  ...
  static final Color black = Color(0xff1f1f1f);
  static final Color gray = Color(0xFFFAF8F8);
  ...
  CustomTheme({
    ...
    //this.primaryColor  = const Color(0xff008fd3),
  ...
  static final CustomTheme lightCustomTheme = CustomTheme(
      ...
      shimmerHighlightColor: Color(0xffdcc7ff));
